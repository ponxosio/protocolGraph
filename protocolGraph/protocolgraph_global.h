...
#  define PROTOCOLBOOLF_EXPORT Q_DECL_EXPORT
#  define PROTOCOLMATHF_EXPORT Q_DECL_EXPORT
#  define CHARACTERISTICCHECK_EXPORT Q_DECL_EXPORT
#  define RANDOMFRACTION_EXPORT Q_DECL_EXPORT
#  define RANDOMINTEGER_EXPORT Q_DECL_EXPORT
#  define TESTOPERATION_EXPORT Q_DECL_EXPORT
#else
...
#  define PROTOCOLBOOLF_EXPORT Q_DECL_IMPORT
#  define PROTOCOLMATHF_EXPORT Q_DECL_IMPORT
#  define CHARACTERISTICCHECK_EXPORT Q_DECL_IMPORT
#  define RANDOMFRACTION_EXPORT Q_DECL_IMPORT
#  define RANDOMINTEGER_EXPORT Q_DECL_IMPORT
#  define TESTOPERATION_EXPORT Q_DECL_IMPORT
#endif
